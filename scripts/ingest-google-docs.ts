/**
 * Triggers Google Docs ingestion by POSTing to the /api/ingest-google-docs endpoint.
 *
 * Required env vars:
...
async function main() {
  const url = `${HOST_URL}/api/ingest-google-docs`;
  console.log(`Triggering Google Docs ingestion at ${url} ...`);
